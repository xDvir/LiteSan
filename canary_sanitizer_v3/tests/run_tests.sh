#!/usr/bin/env bash
#
# run_tests.sh — Comprehensive test suite for canary_sanitizer v3
#
...
echo ""
echo -e "${CYN}╔══════════════════════════════════════════════════════════════╗${RST}"
echo -e "${CYN}║          Canary Sanitizer v3 — Test Suite                   ║${RST}"
echo -e "${CYN}╚══════════════════════════════════════════════════════════════╝${RST}"
echo ""
...
echo -e "${CYN}── v3: Heap Underflow Detection ──${RST}"
...
echo -e "${CYN}── v3: Guard Page Detection ──${RST}"
